...
def vos_tracking_video(video_state, interactive_state, mask_dropdown):
    ...
    video_output = generate_video_from_frames(video_state["painted_images"], output_path="./result/track/{}".format(video_state["video_name"]), fps=round(fps)) # import video_input to name the output video
...
def inpaint_video(video_state, interactive_state, mask_dropdown):
    ...
    video_output = generate_video_from_frames(inpainted_frames, output_path="./result/inpaint/{}".format(video_state["video_name"]), fps=round(fps)) # import video_input to name the output video
...
#iface.launch(share=False,  server_port=7860, server_name="0.0.0.0", debug=False)
iface.launch(inbrowser=True, server_name="127.0.0.1", server_port=7860, share=False)
